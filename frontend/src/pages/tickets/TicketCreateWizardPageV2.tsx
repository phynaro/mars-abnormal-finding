...
const TicketCreateWizardPageV2: React.FC = () => {
  ...
  const onSelectMachine = (machine: SelectedMachine) => {
    ...
    setMachineSearchDropdownOpen(false);
    setPucriticalno(machine.pucriticalno ?? undefined);
                      ...
                      <div className="search-dropdown absolute z-20 mt-1 w-full max-h-64 overflow-auto rounded-md border bg-popover text-popover-foreground shadow-md">
                        {machineSearchLoading || isSearching ? (
                          ...
                          machineSearchResults.map((result, idx) => (
                            ...
                            >
                              <div className="font-medium text-base">{result.puname}</div>
                ...
                <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-green-700 dark:text-green-300 mb-1">{selectedMachine.puname}</p>
            ...
            <div className="space-y-4">
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{selectedMachine?.puname || '-'}</span>
                </div>
...
export default TicketCreateWizardPageV2;
