...
export const menuItems: MenuItem[] = [
  {
    ...
    icon: <div className="h-7 w-7 rounded-full bg-white flex items-center justify-center"><img src="/Eden_Logo.png" alt="MARS Logo" className="h-6 w-6" /></div>,
    path: '/home',
    permissionLevel: 1,
  },
  {
    ...
    children: [
     // { id: 'dashboard-abnormal', label: 'Abnormal Report', icon: <FileText className="h-4 w-4" />, path: '/dashboard/abnormal', permissionLevel: 1 },
      ...
      // { id: 'dashboard-calibration', label: 'Calibration (Legacy)', icon: <FileText className="h-4 w-4" />, path: '/dashboard/calibration', permissionLevel: 1 },
      { id: 'dashboard-calibration-v2', label: 'Calibration', icon: <FileText className="h-4 w-4" />, path: '/dashboard/calibration-v2', permissionLevel: 1 },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'settings-personal-targets', label: 'Personal Target Setting', icon: <Target className="h-4 w-4" />, path: '/settings/personal-targets', permissionLevel: 3 },
